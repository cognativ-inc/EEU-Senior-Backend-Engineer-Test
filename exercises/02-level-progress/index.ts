 ...
 *
 * Rules:
 *   - `totalXp` must be a non-negative integer. Anything else is a programming error: throw an
 ...
 *   - `getXpForLevel` answers "what does level N cost?" for any level in the table, and throws
 *     an `Error` for a level outside it.
 */
